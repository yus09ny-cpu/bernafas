...
export const COACHING_PROMPTS_BM: string[] = [
  ...
  'Lepaskan apa yang anda genggam',
  'Rasakan bahu anda melembut',
  'Ikut irama nafas anda sendiri',
  'Biar fikiran anda perlahan-lahan reda',
  'Setiap nafas, satu langkah lebih tenang',
  'Tiada perlu tergesa-gesa',
]
